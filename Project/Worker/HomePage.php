            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="ViewUserRequest.php" class="nav-item nav-link">User Request</a>
                        <a href="Work.php" class="nav-item nav-link">Add Work</a>
                        <a href="Achievments.php" class="nav-item nav-link">Qualifications</a>
                        <a href="Complaint.php" class="nav-item nav-link">View Complaint</a>
                    ...
                    <a href="MyProfile.php" class="btn btn-primary rounded-pill text-white py-2 px-4 flex-wrap flex-sm-shrink-0">My Profile</a>
                </div>
            </nav>
            ...
            <div class="container py-5">
                ...
                <!-- <div class="row g-4 justify-content-center">
                    ...
                    <!-- <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="blog-item rounded">
                            <div class="blog../Assests/Templates/Main/-img">
