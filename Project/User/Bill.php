...
$selqry="select * from tbl_workrequest r inner join tbl_work w on r.work_id=w.work_id inner join tbl_worker k on w.worker_id=k.worker_id inner join tbl_user u on r.user_id=u.user_id where r.workrequest_id=".$_GET['id'];
        ...
        <table style="width: 100%; table-layout: fixed">
          <tr>
            ...
            >
              ...
              >
              	<span
                style="color:#F93;font-size:56px"> DoorToDoor</span>
