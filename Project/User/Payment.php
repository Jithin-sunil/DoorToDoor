...
session_start();
$selqry="select * from tbl_workrequest w inner join tbl_work r on w.work_id=r.work_id where workrequest_id='".$_GET['pid']."'";
...
{
	$update="update tbl_workrequest set workrequest_status='5' where workrequest_id='".$_GET['pid']."'";
	if($con->query($update))
	{
		?>
        <script>
