...
<head>
  ...
  <!-- base:css -->
  <link rel="stylesheet" href="../Assests/Templates/Admin/polluxui-free-admin-template-1.0.0/template/vendors/typicons/typicons.css">
  <link rel="stylesheet" href="../Assests/Templates/Admin/polluxui-free-admin-template-1.0.0/template/vendors/css/vendor.bundle.base.css">
  <!-- endinject -->
  <!-- plugin css for this page -->
  <!-- End plugin css for this page -->
  <!-- inject:css -->
  <link rel="stylesheet" href="../Assests/Templates/Admin/polluxui-free-admin-template-1.0.0/template/css/vertical-layout-light/style.css">
  <!-- endinject -->
  <link rel="shortcut icon" href="../Assests/Templates/Admin/polluxui-free-admin-template-1.0.0/template/images/favicon.png" />
</head>
<body>
        ...
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item nav-profile dropdown">
            <!-- <a class="nav-link" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="../Assests/Templates/Admin/polluxui-free-admin-template-1.0.0/template/images/faces/face5.jpg" alt="profile"/>
            ...
            <!-- <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                    <img src="../Assests/Templates/Admin/polluxui-free-admin-template-1.0.0/template/images/faces/face4.jpg" alt="image" class="profile-pic">
                </div>
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                    <img src="../Assests/Templates/Admin/polluxui-free-admin-template-1.0.0/template/images/faces/face2.jpg" alt="image" class="profile-pic">
                </div>
                <div class="preview-item-content flex-grow">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                    <img src="../Assests/Templates/Admin/polluxui-free-admin-template-1.0.0/template/images/faces/face3.jpg" alt="image" class="profile-pic">
                </div>
                <div class="preview-item-content flex-grow">
          ...
          <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
            ...
            <ul class="chat-list">
              <li class="list active">
                <div class="profile"><img src="../Assests/Templates/Admin/polluxui-free-admin-template-1.0.0/template/images/faces/face1.jpg" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Thomas Douglas</p>
                  <p>Available</p>
                </div>
              ...
              <li class="list">
                <div class="profile"><img src="../Assests/Templates/Admin/polluxui-free-admin-template-1.0.0/template/images/faces/face2.jpg" alt="image"><span class="offline"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="../Assests/Templates/Admin/polluxui-free-admin-template-1.0.0/template/images/faces/face3.jpg" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Daniel Russell</p>
                  <p>Available</p>
                </div>
              ...
              <li class="list">
                <div class="profile"><img src="../Assests/Templates/Admin/polluxui-free-admin-template-1.0.0/template/images/faces/face4.jpg" alt="image"><span class="offline"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="../Assests/Templates/Admin/polluxui-free-admin-template-1.0.0/template/images/faces/face5.jpg" alt="image"><span class="online"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="../Assests/Templates/Admin/polluxui-free-admin-template-1.0.0/template/images/faces/face6.jpg" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Sarah Graves</p>
                  <p>Available</p>
                </div>
                      ...
                      <div class="row align-items-center h-100">
                        <div class="col-md-4">
                          <figure class="avatar mx-auto mb-4 mb-md-0">
                            <img src="../Assests/Templates/Admin/polluxui-free-admin-template-1.0.0/template/images/faces/face20.jpg" alt="avatar">
                          </figure>
                        </div>
                        <div class="col-md-8">
